...
// 1. Use a game template alreday built
...
// Create a new project reskin based on our template
...
// if happy to create, copy the template to the new location
if (confirmCreateDirectory) {
    ...
    fse.copy(src, destination)
        .then(_ => console.log(`Successfully created ${destination}`.green))
